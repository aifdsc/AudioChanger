...
public class CPolicyConfigVistaClient
{
	...
	public int SetDefaultDevice(string deviceID)
	{
		this._policyConfigVistaClient.SetDefaultEndpoint(deviceID, ERole.eConsole);
		this._policyConfigVistaClient.SetDefaultEndpoint(deviceID, ERole.eMultimedia);
		this._policyConfigVistaClient.SetDefaultEndpoint(deviceID, ERole.eCommunications);
		return 0;
	}
}
